...
HD_PWD='D:/Vivado_Projects/aegis firewall/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_firewall.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_firewall.tcl
